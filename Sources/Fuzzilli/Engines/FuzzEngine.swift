    ...
    public func execute(_ program: Program) -> ExecutionOutcome {
        ...
        switch execution.outcome {
            case .crashed(let termsig):
                fuzzer.processCrash(program, withArgs: execution.args, withSignal: termsig, withStderr: execution.stderr, withStdout: execution.stdout, origin: .local, withExectime: execution.execTime)
